...
namespace Datadog.MAUI.SymbolsUpload.Tests.Integration;
...
public class EndToEndUploadTests : IDisposable
{
    ...
    public void MetadataBuilder_WithCompleteMetadata_ShouldBuildValidPayload()
    {
        ...
        var metadata = new SymbolMetadata
        {
            ...
            GitRepositoryUrl = "https://github.com/DataDog/datadog-ci.git"
        };
        ...
        Assert.Equal("https://github.com/DataDog/datadog-ci.git", payload["git_repository_url"]);
    }
